...
import { HandleCoverLetterRequest } from "@data/request/handle-cover-letter.request";
...
export class CoverLetterController {
  ...
  async handleCoverLetter(
    @Body() handleCoverLetterRequest : HandleCoverLetterRequest
  ) {
    const HandleCoverLetterRequestResponse = await this.coverLetterService.HandleCoverLetter(handleCoverLetterRequest.coverLetterId,handleCoverLetterRequest.status);
    return HttpResponse.success(HandleCoverLetterRequestResponse)
  }
