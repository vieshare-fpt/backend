...
export class FollowController {
  ...
  async deleteFollow(
    ...
    const deleteFollow = await this.followService.deleteFollow(user.id, followerId);
  ...
  @HttpCode(HttpStatus.OK)
  async createFollow(
    @Body() followReq: CreateFollowRequest,
    @CurrentUser() user: User
  ) {
    return await this.followService.createFollow(user.id, followReq.followerId);
  }
